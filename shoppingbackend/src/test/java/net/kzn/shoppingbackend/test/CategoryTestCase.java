...
public class CategoryTestCase {
	 ...
	 * assertEquals("Successfully fetched a category from the table!"
	 * ,"Laptop",category.getName()); }
	 */

	/*
	 * @Test public void testUpdateCategory () { category = categoryDAO.get(2);
	 * category.setActive(true); category.setName("Tele"); assertEquals(
	 * "Successfully updated a category in the table!"
	 * ,true,categoryDAO.update(category)); }
	 */

	/*
	 * @Test public void testDeleteCategory () { category = categoryDAO.get(2);
	 * assertEquals("Successfully delete a category in the table!"
